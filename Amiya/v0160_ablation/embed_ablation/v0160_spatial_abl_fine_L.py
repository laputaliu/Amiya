...
class Amiya(torch.nn.Module):
    ...
    def forward(self, x, edge_index, rxn_exp,
        ...
        out_rxn = F.gelu(self.embed_rxn_map(met_concat))
...
if __name__ == '__main__':
    ...
    record = True
    run_comment = "{}_v0160_spatial_abl_finetuning_L".format(datetime.datetime.now().strftime('%y%m%d-%H%M'))
    ...
    for n_fold, (train_ids, val_ids) in enumerate(kfold_iter.split(train_val_dataset)):
        ...
        checkpoint_path='/data/home/liuzhaoyang/ES/project/MetaSpace/large_ST/v0160_ablation/embed_ablation/v0160_spatial_abl_pre/Amiya_0160_spatial_abl_pre-L/version_12/checkpoints/Amiya_0160_spatial_abl_pretrain-L_epoch=49.ckpt',
        met_edge_index=met_edge_index,
        lr=lr_FT,
        wd=wd_FT,
        record_flag=record,
        ...
        checkpoint_callback = ModelCheckpoint(
                filename="Amiya_0160_spatial_abl_finetuning-L_{epoch:02d}",
        ...
        logger = TensorBoardLogger(save_dir='./v0160_spatial_abl_fine/', name="Amiya_0160_spatial_abl_fine-L")
