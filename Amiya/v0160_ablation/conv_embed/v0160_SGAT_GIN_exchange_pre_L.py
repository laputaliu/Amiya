...
if __name__ == '__main__':
    ...
    record = True
    run_comment = "{}_v0160_SGAT_abl_pretrain_L".format(datetime.datetime.now().strftime('%y%m%d-%H%M'))
    ...
    for n_fold, (train_ids, val_ids) in enumerate(kfold_iter.split(train_val_dataset)):
        ...
        checkpoint_callback = ModelCheckpoint(
                filename="Amiya_0160_SGAT_GIN_exchange_pretrain-L_{epoch:02d}",
        ...
        logger = TensorBoardLogger(save_dir='./v0160_SGAT_GIN_exchange_pre/', name="Amiya_0160_SGAT_GIN_exchange_pre-L")
